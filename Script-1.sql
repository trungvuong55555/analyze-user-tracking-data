...
create function count_appear (userId int, start_timestamp timestamp, end_timestamp timestamp)
returns int
language plpgsql
as $$
declare
...
select * from range_movement (0, 0, 100, TIMESTAMP '2023-06-07 10:40:28', TIMESTAMP '2023-06-07 20:40:28');
